...
if ($botaomat == "ordenar")
{
    $query .= " ORDER BY materias.nomemateria ASC";
}
...
<a href="home.php?botaomat=ordenar&botaoprof=<?php echo $botaoprof; ?>">Ordenar matérias</a>
...
if ($botaoprof == "ordenar")
{
    $query .= " ORDER BY professor.nome ASC";
}
...
<br><br>
<a href="home.php?botaoprof=ordenar&botaomat=<?php echo $botaomat; ?>">Ordenar professores</a>